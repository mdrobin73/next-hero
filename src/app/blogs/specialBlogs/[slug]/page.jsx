...
const page = ({params}) => {
    ...
    return (
        <div className='p-10 space-y-5 bg-slate-900 text-slate-200 w-2/3 mt-10 mx-auto border border-red-400 rounded-md shadow-xl'>
            <h2 className='text-2xl font-semibold border border-red-400 p-2 text-center bg-slate-800 max-w-md rounded-lg shadow-xl'>{title}</h2>
            <p className='bg-slate-800 rounded-lg shadow-xl p-3'>{description}</p>
        </div>
    );
};
